...
./wp-cli.phar core install --url="wordpress.net" --title="WordPress in the cloud" --admin_user="wordpress_admin" --admin_password="wordpress_password" --admin_email="pklawit@gmail.com" --path=/var/www/html --allow-root
